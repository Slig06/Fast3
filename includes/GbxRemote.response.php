...
// rpc_method() to build an method array (for method call in a multicall)
...
// -----------------------------------------------------------------------
// Build a methodCall request in xml-rpc format from methodname and php arrays params
...
// -----------------------------------------------------------------------
// Build a methodCall response in xml-rpc format from php arrays args
// (array_response ==> xml-rpc string)
// -----------------------------------------------------------------------
// $args should be an array containning the response
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// Build a method struct (php array) usable for a method call in a multicall
...
// -----------------------------------------------------------------------
// Build a response struct (php array) usable as a reply for a method in a multicall
// (method name + params array ==> method struct array
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------
// Build an error struct (php array) usable as a error reply for a method in a multicall
